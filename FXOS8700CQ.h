...
enum magOSR {
		...
		MOSR_1 = 1,     // oversample ratio 2 at 50 and 200 Hz ODR
		MOSR_2 = 2,     // oversample ratio 2 at 50 and 200 Hz ODR
		MOSR_3 = 3,     // oversample ratio 2 at 50 and 200 Hz ODR
		MOSR_4 = 4,     // oversample ratio 2 at 200 Hz ODR, 4 at 50 HZ ODR
		MOSR_5 = 5,     // oversample ratio 2 at 200 Hz ODR, 8 at 50 HZ ODR
		MOSR_6 = 6,        // oversample ratio 4 at 200 Hz ODR, 16 at 50 HZ ODR
		MOSR_7 = 7         // oversample ratio 8 at 200 Hz ODR, 32 at 50 HZ ODR
};
...
class FXOS8700CQ {
		public:
				...
				// Register functions
				void writeReg(byte reg, byte data); 	// Write to a register
